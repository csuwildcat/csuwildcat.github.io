---
title: "The Future is AI's Proof of Work"
pubDatetime: 2026-02-25T15:52:33Z
draft: false
featured: true
...
tags:
  - AI
  - Predictions
description: In the race to advance AI systems, measuring their ability is critical, and the future is how we will grade them.
ogImage: ../../assets/images/ai-vs-time.png
---
...
::image[Prediction Visualization]{src="/src/assets/images/prediction-cone.png" maxWidth="700px"}
...
::image[Future POW Example]{src="/src/assets/images/future-pow-example.png" maxWidth="700px"}
...
::image[Hunch Hero Logo]{src="/src/assets/images/hunch-hero-logo.png" maxWidth="400px" data-no-zoom="true"}

Hunch is now available on the Play Store and the App Store. Let me know what you think!

<div style="display:flex; gap:12px; flex-wrap:wrap; justify-content:center; align-items:center; margin:1.5rem 0;">
  <a
    href="https://play.google.com/store/apps/details?id=fn.hunch"
    target="_blank"
    rel="noopener noreferrer"
    data-no-zoom="true"
    style="display:flex; align-items:center; justify-content:center; height:56px; overflow:hidden;"
  >
    <img
      src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png"
      alt="Get it on Google Play"
      data-no-zoom="true"
      style="height:77px; width:auto; margin:0 !important; border:none !important; display:block;"
    />
  </a>
  <a
    href="https://apps.apple.com/us/app/hunch/id6749600848"
    target="_blank"
    rel="noopener noreferrer"
    data-no-zoom="true"
    style="display:flex; align-items:center; justify-content:center; height:56px;"
  >
    <img
      src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83"
      alt="Download on the App Store"
      data-no-zoom="true"
      style="height:50px; width:auto; margin:0 !important; border:none !important; display:block;"
    />
  </a>
</div>

::image[Hunch Feed]{src="/src/assets/images/hunch-feed.png" class="float-left w-[32%] !my-0 mx-[0.66%]" imgClass="!my-0"}
::image[Hunch Track]{src="/src/assets/images/hunch-track.png" class="float-left w-[32%] !my-0 mx-[0.66%]" imgClass="!my-0"}
::image[Hunch Detail]{src="/src/assets/images/hunch-detail.png" class="float-left w-[32%] !my-0 mx-[0.66%]" imgClass="!my-0"}
